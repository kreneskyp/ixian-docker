...
def mock_build_image_if_needed(
    ...
    def setup(image, scenario="image_does_not_exist"):
        ...
        if scenario == "image_exists":
            ...
            print("uhhh ", mock_get_image, mock_get_image.not_found)
    ...
    def assert_build(
        ...
        if mock_build:
            ...
            print("WUT: ", mock_docker_environment)
            print("WUT: ", mock_get_image)
        ...
        print("mock_build:", mock_build)
        print("image_exists(image):", image_exists(image)), image_exists
