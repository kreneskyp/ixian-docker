class PythonModuleConfig(object):
    ...
    name = 'PYTHON'
    tasks = 'power_shovel_docker.modules.python2.tasks'
    config = 'power_shovel_docker.modules.python2.config.PythonConfig'
    ...
    def dev_volumes(self):
        from power_shovel_docker.modules.python2.utils \
            import pipenv_local_package_mount_flags
