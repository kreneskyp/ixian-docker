...
snapshots['TestPythonConfig.test_read[HOST_ROOT_MODULE_PATH] 1'] = '/opt/power_shovel_docker/unittests'
...
snapshots['TestPythonConfig.test_read[MODULE_DIR] 1'] = '/opt/power_shovel_docker/power_shovel_docker/modules/python'
